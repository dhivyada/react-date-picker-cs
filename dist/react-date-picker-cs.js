...
var SelectYear = function (_React$Component) {
	inherits(SelectYear, _React$Component);

	function SelectYear() {
		classCallCheck(this, SelectYear);
		return possibleConstructorReturn(this, (SelectYear.__proto__ || Object.getPrototypeOf(SelectYear)).apply(this, arguments));
	}

	createClass(SelectYear, [{
		key: 'handleChange',
		...
		value: function render() {
			...
			return react.createElement(
				'select',
				{ value: this.props.year, className: 'datePicker__year', onChange: function onChange(e) {
...
var SelectMonth = function (_React$Component) {
	inherits(SelectMonth, _React$Component);

	function SelectMonth() {
		classCallCheck(this, SelectMonth);
		return possibleConstructorReturn(this, (SelectMonth.__proto__ || Object.getPrototypeOf(SelectMonth)).apply(this, arguments));
	}

	createClass(SelectMonth, [{
		key: 'handleChange',
		value: function handleChange(e) {
		...
		value: function render() {
			...
			return react.createElement(
				'select',
				{ value: this.props.month, className: 'datePicker__month', onChange: function onChange(e) {
						return _this2.handleChange(e);
					} },
				options
			);
...
var Week = function (_React$Component) {
	...
	function Week() {
		...
		return possibleConstructorReturn(this, (Week.__proto__ || Object.getPrototypeOf(Week)).apply(this, arguments));
	}
		...
		value: function render() {
			...
			var days = (typeof this.props.days === 'undefined' ? [] : this.props.days).map(function (day, index) {
				if (day) {
					...
					// 仅高亮今天
					if (day === _this2.props.day && _this2.props.highlight) {
						return react.createElement(
							'td',
							{ key: index, className: 'datePicker__day--today datePicker__day',
						...
						return react.createElement(
							'td',
							{ key: index, className: 'datePicker__day', onClick: function onClick(e) {
									return _this2.handleClick(e);
								} },
							day
						);
					...
					return react.createElement('td', { key: index, className: 'datePicker__day--disabled datePicker__day' });
				}
			});
...
var WeekDays = function (_React$Component) {
	inherits(WeekDays, _React$Component);
	...
	createClass(WeekDays, [{
		...
		value: function render() {
			...
			var range = [].concat(toConsumableArray(Array(days))).map(function (_, i) {
				return i + 1;
			});
			...
			for (var j = 0, len = chunks.length; j < len; j++) {
				...
				weekDays.push(react.createElement(Week, { key: j, highlight: this.props.highlight, days: chunks[j], selectDay: function selectDay(val) {
						return _this2.selectDay(val);
					}, day: Number(this.props.day) }));
			}
			var weekTitle = void 0;
			if (this.props.locale === 'zh') {
...
var Calendar = function (_React$Component) {
	...
	function Calendar() {
		...
		return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = Calendar.__proto__ || Object.getPrototypeOf(Calendar)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			year: new Date(_this.props.date || getToday()).getFullYear(),
			month: new Date(_this.props.date || getToday()).getMonth() + 1,
			day: new Date(_this.props.date || getToday()).getDate()
			...
			return react.createElement(
				...
				react.createElement(
					...
					react.createElement('span', { onClick: function onClick(e) {
							return _this3.prevMonth(e);
						}, className: 'datePicker__prev' }),
					react.createElement(SelectYear, { year: Number(this.state.year), selectYear: function selectYear(year) {
							return _this3.selectYear(year);
						}, range: this.props.range }),
					react.createElement(SelectMonth, { month: Number(this.state.month), selectMonth: function selectMonth(month) {
							return _this3.selectMonth(month);
						}, locale: this.props.locale }),
					react.createElement('span', { onClick: function onClick(e) {
							return _this3.nextMonth(e);
						}, className: 'datePicker__next' })
				),
				react.createElement(WeekDays, { locale: this.props.locale,
				...
				react.createElement(
					...
					react.createElement(
						'button',
						{ className: 'datePicker__btn datePicker__btn--today',
							onClick: function onClick(props) {
								return _this3.props.selectToday(props);
							} },
...
var ReactDatePicker = function (_React$Component) {
	inherits(ReactDatePicker, _React$Component);
	...
	function ReactDatePicker() {
		...
		classCallCheck(this, ReactDatePicker);

		for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
			args[_key] = arguments[_key];
		}

		return _ret = (_temp = (_this = possibleConstructorReturn(this, (_ref = ReactDatePicker.__proto__ || Object.getPrototypeOf(ReactDatePicker)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			isCalendarShow: false
		}, _temp), possibleConstructorReturn(_this, _ret);
	}

	createClass(ReactDatePicker, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			var _this2 = this;

			document.addEventListener('click', function () {
				return _this2.documentClickHandler;
			});
		}
	}, {
		...
		value: function componentWillUnmount() {
			...
			document.removeEventListener('click', function () {
				return _this3.documentClickHandler;
			});
		}
	}, {
		...
		key: 'onClickDatePickerArea',
		value: function onClickDatePickerArea(e) {
		...
		key: 'onClickCalendar',
		value: function onClickCalendar(date) {
			this.setState({
				isCalendarShow: false
			});
...
//# sourceMappingURL=react-date-picker-cs.js.map
